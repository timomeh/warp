...
const REQUEST_PROJECT = 'warp/project/REQUEST_PROJECTS'
const RECEIVE_PROJECT = 'warp/project/RECEIVE_PROJECTS'
const REQUEST_BUILDS = 'warp/project/REQUEST_BUILDS'
const RECEIVE_BUILDS = 'warp/project/RECEIVE_BUILDS'
