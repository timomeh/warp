...
import { addEntities, updateProject, fetchBuild, addLogLine } from 'lib/store'
...
class Socket {
  ...
  join(room, attrs = {}) {
    ...
    channel.on('event', payload => {
      ...
      if (entityName === 'log' && eventType === 'add') {
        this.dispatch(addLogLine(response.step_id, response.line))
      }
